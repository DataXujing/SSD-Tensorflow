...
tf.app.flags.DEFINE_integer(
    'num_classes', 2, 'Number of classes to use in the dataset.')  # 这里在训练的过程中忘了修改了，需要修改
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            for i in range(video_frame_cnt):
                ...
                cv2.putText(img_to_draw, '{:.2f}ms'.format((end_time - start_time) * 1000), (40, 40), 0,
            ...
            # np_image = imread('./data/test_img/3.jpg')
            # labels_, scores_, bboxes_ = sess.run([all_labels, all_scores, all_bboxes], feed_dict = {image_input : np_image, shape_input : np_image.shape[:-1]})
